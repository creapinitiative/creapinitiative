      ...
      <section className="py-24 bg-bg">
        <Reveal as="div" className="mx-auto max-w-[1200px] px-5 sm:px-8 md:px-12 lg:px-28 grid lg:grid-cols-5 gap-12">
          ...
          <form
            ...
            className="lg:col-span-3 bg-white border border-rule rounded-sm p-8 lg:p-10 grid sm:grid-cols-2 gap-5"
          >
            <label className="flex flex-col gap-2">
              <span className="text-ink3 font-medium">Full name *</span>
              <input name="name" required className="border border-rule rounded-sm px-4 py-3 focus:outline-none focus:border-gold transition" />
            </label>
            <label className="flex flex-col gap-2">
              <span className="text-ink3 font-medium">Email *</span>
              <input name="email" required type="email" className="border border-rule rounded-sm px-4 py-3 focus:outline-none focus:border-gold transition" />
            </label>
            <label className="sm:col-span-2 flex flex-col gap-2">
              <span className="text-ink3 font-medium">Subject</span>
              <input name="subject" className="border border-rule rounded-sm px-4 py-3 focus:outline-none focus:border-gold transition" />
            </label>
            <label className="sm:col-span-2 flex flex-col gap-2">
              <span className="text-ink3 font-medium">Message *</span>
              <textarea name="message" required rows={6} className="border border-rule rounded-sm px-4 py-3 focus:outline-none focus:border-gold transition" />
            </label>
            <button
